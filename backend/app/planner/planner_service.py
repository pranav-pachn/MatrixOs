...
from app.planner.llm import GeminiPlanner, DeepSeekPlanner, OpenRouterPlanner
from app.runtime.state_manager import state_manager
from app.adapters.registry import get as get_adapter

class PlannerService:
    def __init__(self):
        # We can implement a routing strategy here. For now, use Gemini as primary.
        self.primary_planner = GeminiPlanner()
