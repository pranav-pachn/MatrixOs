...
import { Package, ArrowLeft } from "@phosphor-icons/react/dist/ssr";

export default function WarehouseStubPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 bg-background relative overflow-hidden">
      ...
      <div className="max-w-md w-full bg-card/40 backdrop-blur-xl border border-border/50 rounded-2xl p-8 text-center shadow-2xl relative z-10">
        ...
        <h1 className="text-3xl font-bold font-sans tracking-tight text-foreground mb-3">Warehouse <br/><span className="text-primary text-xl">Adapter Offline</span></h1>
        
        <p className="text-sm font-sans text-muted-foreground mb-8">
          The autonomous robotics routing and loading dock optimization adapters are currently offline. System requires physical calibration of Boston Dynamics IoT endpoints before resuming connection.
        </p>
        ...
        <div className="inline-block border border-border/50 bg-background/50 rounded-lg px-4 py-2 mb-8 font-mono text-xs text-muted-foreground uppercase tracking-widest shadow-neu-inset">
          Status: <span className="text-chart-2 ml-2">Awaiting Calibration...</span>
        </div>
